...
export default function SolutionsPage() {
    ...
    return (
        <section className="relative w-full min-h-screen pt-16 pb-12 px-4 bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-white flex flex-col overflow-x-hidden">
            ...
            {/* Footer */}
            <footer className="absolute bottom-0 w-full border-t border-slate-200/60 dark:border-gray-700 bg-slate-50 dark:bg-gray-800 py-2 px-4 transition-colors duration-300 z-20">
